...
class StatusPill extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    switch (status) {
      case 'Aberta': color = Colors.teal.shade600; bgColor = Colors.teal.shade50; break;
      case 'Atribuída': color = Colors.purple.shade600; bgColor = Colors.purple.shade50; break;
      ...
      case 'Cancelada': color = Colors.grey.shade700; bgColor = Colors.grey.shade200; break;
