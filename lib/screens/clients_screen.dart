                ...
                Expanded(
                  child: ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final osCount = provider.workOrders
...
class _ClientFormScreenState extends State<ClientFormScreen> {
  ...
  MaskTextInputFormatter docMask = MaskTextInputFormatter(
    mask: '##.###.###/####-##',
    filter: {"#": RegExp(r'[0-9]')},
  );
  ...
  void initState() {
    ...
    _clientType = widget.client != null
        ? (widget.client!.document.replaceAll(RegExp(r'[^0-9]'), '').length > 11
              ? 'Pessoa jurídica'
              : 'Pessoa física')
        : 'Pessoa jurídica';
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            Text(
              widget.client == null ? 'Cadastrar cliente' : 'Editar cliente',
              style: const TextStyle(
                fontWeight: FontWeight.bold,
                color: Colors.black87,
                fontSize: 22,
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Expanded(
                    flex: 1,
                    child: _buildField('UF', _uf, (val) => _uf = val, true),
                  ),
                ],
              ),
            ],
            ...
            child: ElevatedButton(
              ...
              onPressed: () {
                if (_formKey.currentState!.validate()) {
                  ...
                  bool isDuplicate = provider.clients.any(
                    (c) => c.document == _document && c.id != widget.client?.id,
                  );
                  if (isDuplicate) {
